...
def dqn():
    ...
    max_steps = 800 # max number of steps per game (None for infinite)
    epsilon_stop_episode = 700 # at what episode the random exploration stops
    mem_size = 700 # maximum number of steps stored by the agent
    discount = 0.93 # discount in the Q-learning formula (see DQNAgent)
    batch_size = 64 # number of actions to consider in each training
    ...
    replay_start_size = 300 # minimum steps stored in the agent required to start training
